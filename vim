...
Ctrl W + -  - Make window smaller by column
Ctrl W + +  - Make window taller by column
Ctrl W + >  - Make window wider by row
Ctrl W + <  - Make window narrower by row
